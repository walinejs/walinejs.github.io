import{_ as d}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as u,c as _,a as m,b as n,e as s,f as a,w as e,d as p,r as t}from"./app.ce144736.js";const h={},v=n("p",null,"如果你担忧免费平台的请求延时，你也可以选择部署在自己的服务器上。",-1),y=p(`<h2 id="docker-部署" tabindex="-1"><a class="header-anchor" href="#docker-部署" aria-hidden="true">#</a> Docker 部署</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
...
</code></pre></div></div>`,4),g={id:"使用-docker-stack-deploy-或者-docker-compose",tabindex:"-1"},b=n("a",{class:"header-anchor",href:"#使用-docker-stack-deploy-或者-docker-compose","aria-hidden":"true"},"#",-1),w={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},x={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},f=p(`<p><code>docker-compose.yml</code> 示例:</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
</code></pre></div><h2 id="直接运行-推荐" tabindex="-1"><a class="header-anchor" href="#直接运行-推荐" aria-hidden="true">#</a> 直接运行 (推荐)</h2><p>不使用容器部署的话运行也很简单。在配置必要的环境变量后，安装好模块后直接运行模块内的 <code>vanilla.js</code> 文件即可。</p>`,4),E=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"yarn"),s(),n("span",{class:"token function"},"add"),s(` @waline/vercel
...
`),n("span",{class:"token function"},"node"),s(` node_modules/@waline/vercel/vanilla.js
`)])])],-1),A=p(`<h2 id="nginx-配置" tabindex="-1"><a class="header-anchor" href="#nginx-配置" aria-hidden="true">#</a> Nginx 配置</h2><p>如果你不想带端口访问的话，可以增加 Nginx 80 和 443 端口的反代。可参考如下配置:</p><div class="language-nginx" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span>
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function L(C,T){const o=t("ExternalLinkIcon"),c=t("RouterLink"),l=t("CodeTabs");return u(),_("div",null,[v,m(" more "),y,n("h3",g,[b,s(" 使用 "),n("a",w,[s("docker stack deploy"),a(o)]),s(" 或者 "),n("a",x,[s("docker-compose"),a(o)])]),n("p",null,[s("这里使用了 SQLite 数据库作为例子。关于 SQLite 和支持的数据库服务，请参考"),a(c,{to:"/guide/database.html#sqlite"},{default:e(()=>[s("多数据库服务支持")]),_:1}),s("。")]),f,a(l,{id:"30",data:[{title:"yarn"},{title:"npm"}],"tab-id":"shell"},{tab0:e(({title:r,value:i,isActive:k})=>[E]),tab1:e(({title:r,value:i,isActive:k})=>[S]),_:1}),A])}const R=d(h,[["render",L],["__file","vps.html.vue"]]);export{R as default};
