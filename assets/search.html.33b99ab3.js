import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as o,f as e,a as n,b as c,d as s,e as l,r as i}from"./app.9e17ec7b.js";const u={},r=n("p",null,"Waline allows users to add emoticons search services and customize this feature.",-1),k=n("h2",{id:"introduction",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#introduction","aria-hidden":"true"},"#"),s(" Introduction")],-1),d=s("By default, Waline provides meme search service through "),m={href:"https://tenor.com/",target:"_blank",rel:"noopener noreferrer"},h=s("tenor"),g=s(". This will allow you to search for images and add to comments while commenting."),f=l(`<h2 id="disable" tabindex="-1"><a class="header-anchor" href="#disable" aria-hidden="true">#</a> disable</h2><p>If you don&#39;t need the default images search service, you can disable it by setting the <code>search</code> option to <code>false</code>.</p><div class="language-javascript ext-js"><pre class="language-javascript"><code>Waline<span class="token punctuation">.</span><span class="token function">init</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div></details>`,17);function y(w,b){const a=i("ExternalLinkIcon");return p(),o("div",null,[r,e(" more "),k,n("p",null,[d,n("a",m,[h,c(a)]),g]),f])}const _=t(u,[["render",y],["__file","search.html.vue"]]);export{_ as default};
