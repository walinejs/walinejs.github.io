...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,8);function A(L,R){const e=t("ExternalLinkIcon"),p=t("RouterLink");return l(),r(k,null,[u,s("h3",h,[_,m,s("a",y,[v,a(e)]),g,s("a",w,[f,a(e)])]),s("p",null,[x,a(p,{to:"/en/guide/databases.html#sqlite"},{default:i(()=>[b]),_:1}),E]),S],64)}var D=c(d,[["render",A],["__file","vps-deploy.html.vue"]]);export{D as default};
