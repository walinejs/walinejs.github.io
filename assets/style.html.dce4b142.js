import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as e,f as t,a as n,d as a,e as p}from"./app.f1b9b82d.js";const c={},l=n("p",null,[n("code",null,"@waline/client"),a(" provides some CSS variables. You can easily configure the style of waline through these variables:")],-1),r=n("p",null,[a("Meanwhile, "),n("code",null,"@waline/client"),a(" also has built-in dark mode support.")],-1),i=p(`<h2 id="variables" tabindex="-1"><a class="header-anchor" href="#variables" aria-hidden="true">#</a> Variables</h2><div class="language-css ext-css"><pre class="language-css"><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
<span class="token atrule"><span class="token rule">@media</span> <span class="token punctuation">(</span><span class="token property">prefers-color-scheme</span><span class="token punctuation">:</span> dark<span class="token punctuation">)</span></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="more" tabindex="-1"><a class="header-anchor" href="#more" aria-hidden="true">#</a> More</h2><p>If the above CSS variables cannot meet your custom requirements for Waline styles, you can write your own css file.</p>`,18);function u(d,k){return o(),e("div",null,[l,r,t(" more "),i])}const f=s(c,[["render",u],["__file","style.html.vue"]]);export{f as default};
