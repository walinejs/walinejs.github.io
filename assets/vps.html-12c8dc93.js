import{ac as u,B as k,C as v,G as m,z as n,O as s,J as a,ae as e,ad as p,R as t}from"./framework-2ded1d0f.js";const b={},h=n("p",null,"如果你担忧免费平台的请求延时，你也可以选择部署在自己的服务器上。",-1),_=p(`<h2 id="docker-部署" tabindex="-1"><a class="header-anchor" href="#docker-部署" aria-hidden="true">#</a> Docker 部署</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
  ...
  lizheming/waline
</code></pre></div><p><code>LEAN_ID</code> 和 <code>LEAN_KEY</code> 分别对应的是后台得到的 App Id 和 App Key。如果非 LeanCloud 国际版用户的话需要在后台绑定已备案域名并配置 <code>LEAN_SERVER</code>。</p><div class="hint-container tip"><p class="hint-container-title">如何构建镜像？</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/walinejs/waline.git
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function L(C,T){const c=t("ExternalLinkIcon"),o=t("RouterLink"),l=t("CodeTabs");return k(),v("div",null,[h,m(" more "),_,n("h3",y,[g,s(" 使用 "),n("a",w,[s("docker stack deploy"),a(c)]),s(" 或者 "),n("a",x,[s("docker-compose"),a(c)])]),n("p",null,[s("这里使用了 SQLite 数据库作为例子。关于 SQLite 和支持的数据库服务，请参考"),a(o,{to:"/guide/database.html#sqlite"},{default:e(()=>[s("多数据库服务支持")]),_:1}),s("。")]),E,a(l,{id:"30",data:[{title:"yarn"},{title:"npm"}],"tab-id":"shell"},{tab0:e(({title:i,value:r,isActive:d})=>[f]),tab1:e(({title:i,value:r,isActive:d})=>[S]),_:1}),A])}const R=u(b,[["render",L],["__file","vps.html.vue"]]);export{R as default};
