...
</code></pre></div>`,6);function f(y,x){const s=u("ExternalLinkIcon");return c(),l("div",null,[k,n("ul",null,[n("li",null,[n("a",r,[a("lightGallery"),t(s)])])]),p(" - [Slimbox2](https://www.digitalia.be/software/slimbox2/) "),n("ul",null,[n("li",null,[n("a",g,[a("lightbox2"),t(s)])]),n("li",null,[n("a",d,[a("Fancybox"),t(s)])])]),p(" more "),m,p(`
## Slimbox2
...
\`\`\` `),h])}const v=e(i,[["render",f],["__file","image-preview.html.vue"]]);export{v as default};
