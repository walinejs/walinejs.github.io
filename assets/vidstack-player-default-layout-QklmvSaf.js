  ...
  `}function Ps(){return i(()=>{const{live:e,duration:t}=v();return e()?Xt():t()?o`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function re(){return i(()=>{const{live:e}=v();return e()?Xt():Ms()})}function ue(){return i(()=>{const{textTracks:e}=k(),{title:t,started:s}=v(),n=x(null);return Kt(e,"chapters",n.set),n()&&(s()||!t())?de():o`<media-title class="vds-chapter-title"></media-title>`})}function de(){return o`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class ce extends Ee{async Pf(){const t=(await Ce(()=>import("./vidstack-CRlTZX3Z-PBDNdscv.js"),__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Fe({name:n,paths:t[n]});return s}}var G;let Is=(G=class extends N{},G.props={...lt(G,G,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},G);function Os(){return[$t(),xt(),o`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
          ${[Gt({backward:!0,tooltip:"top start"}),X({tooltip:"top"}),Gt({tooltip:"top"}),Vs(),Dt(),Ps(),Tt({orientation:"vertical",tooltip:"top"}),gt({tooltip:"top"}),yt(),bt({tooltip:"top"}),Gs()]}
