...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div></details>`,17);function h(g,f){const a=i("ExternalLinkIcon");return p(),o("div",null,[r,e(" more "),k,n("p",null,[s("By default, Waline provides meme search service through "),n("a",d,[s("tenor"),c(a)]),s(". This will allow you to search for images and add to comments while commenting.")]),m])}const b=t(u,[["render",h],["__file","search.html.vue"]]);export{b as default};
