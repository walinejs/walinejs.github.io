...
<span class="token punctuation">)</span><span class="token operator">:</span> WalineSearchOptions <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div></details>`,18);function g(h,f){const a=u("ExternalLinkIcon");return p(),o("div",null,[r,e(" more "),k,n("p",null,[s("By default, Waline provides meme search service through "),n("a",d,[s("Giphy"),c(a)]),s(". This will allow you to search for images and add to comments while commenting.")]),m])}const b=t(i,[["render",g],["__file","search.html.vue"]]);export{b as default};
