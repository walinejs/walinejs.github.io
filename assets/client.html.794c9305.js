import{_ as i}from"./plugin-vue_export-helper.21dcd24c.js";import{r as a,o,c,a as s,b as l,w as r,F as d,e as n,d as e}from"./app.57b8dfca.js";const p={},u=n(`<h2 id="client-api" tabindex="-1"><a class="header-anchor" href="#client-api" aria-hidden="true">#</a> Client API</h2><p>Waline provides three APIs:</p><ul><li><p><code>init</code>: Initialize Waline</p></li><li><p><code>commentCount</code>: Count comments</p></li><li><p><code>pageviewCount</code>: Count pageviews</p></li></ul><p>As well as:</p><ul><li><p><code>RecentComment</code>: Waline recent comments widget</p></li><li><p><code>version: string</code>: Waline client version</p></li></ul><h2 id="init" tabindex="-1"><a class="header-anchor" href="#init" aria-hidden="true">#</a> init</h2><p>The <code>init</code> API accepts a <code>WalineInitOptions</code> options and returns a <code>WalineInstance</code>.</p><p>Type:</p><div class="language-typescript ext-ts"><pre class="language-typescript"><code>const init: (options: WalineInitOptions) =&gt; WalineInstance;
