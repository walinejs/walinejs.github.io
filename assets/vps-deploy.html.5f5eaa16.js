...
</code></pre></div></div>`,5),_={id:"\u4F7F\u7528-docker-stack-deploy-\u6216\u8005-docker-compose",tabindex:"-1"},h=n("a",{class:"header-anchor",href:"#\u4F7F\u7528-docker-stack-deploy-\u6216\u8005-docker-compose","aria-hidden":"true"},"#",-1),m=s(" \u4F7F\u7528 "),v={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},y=s("docker stack deploy"),g=s(" \u6216\u8005 "),w={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},x=s("docker-compose"),E=s("\u8FD9\u91CC\u4F7F\u7528\u4E86 SQLite \u6570\u636E\u5E93\u4F5C\u4E3A\u4F8B\u5B50\u3002\u5173\u4E8E SQLite \u548C\u652F\u6301\u7684\u6570\u636E\u5E93\u670D\u52A1\uFF0C\u8BF7\u53C2\u8003"),b=s("\u591A\u6570\u636E\u5E93\u670D\u52A1\u652F\u6301"),f=s("\u3002"),S=p(`<p><code>docker-compose.yml</code> \u793A\u4F8B:</p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,8);function A(L,C){const e=t("ExternalLinkIcon"),o=t("RouterLink");return l(),r(k,null,[u,n("h3",_,[h,m,n("a",v,[y,a(e)]),g,n("a",w,[x,a(e)])]),n("p",null,[E,a(o,{to:"/guide/server/databases.html#sqlite"},{default:i(()=>[b]),_:1}),f]),S],64)}var N=c(d,[["render",A]]);export{N as default};
