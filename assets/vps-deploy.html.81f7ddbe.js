...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,11);function A(L,N){const e=t("ExternalLinkIcon"),o=t("RouterLink");return l(),r(k,null,[u,s("h3",h,[_,m,s("a",v,[y,a(e)]),g,s("a",w,[x,a(e)])]),s("p",null,[b,a(o,{to:"/guide/server/databases.html#sqlite"},{default:i(()=>[f]),_:1}),E]),S],64)}var D=c(d,[["render",A]]);export{D as default};
