import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,f as e}from"./app-dhYyr2Xl.js";const i={},t=e(`<p>Waline 官方提供 <code>@waline/api</code> 包，以供官方客户端、第三方客户端开发者和用户调用 Waline 后端接口。</p><h2 id="api" tabindex="-1"><a class="header-anchor" href="#api" aria-hidden="true">#</a> API</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">BaseAPIOptions</span> <span class="token punctuation">{</span>
