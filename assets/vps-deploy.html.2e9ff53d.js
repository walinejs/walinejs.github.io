...
</code></pre></div></div>`,5),_={id:"via-docker-stack-deploy-or-docker-compose",tabindex:"-1"},m=s("a",{class:"header-anchor",href:"#via-docker-stack-deploy-or-docker-compose","aria-hidden":"true"},"#",-1),v=n(" via "),y={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},g=n("docker stack deploy"),w=n(" or "),f={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},b=n("docker-compose"),x=n("The SQLite is used here as an example. For SQLite and supported database services, please refer to "),E=n("Multi-database service support"),S=n("."),A=t(`<p>Example <code>docker-compose.yml</code> for <code>waline</code>:</p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function C(T,R){const o=e("ExternalLinkIcon"),p=e("RouterLink"),c=e("CodeTabs");return r(),i(d,null,[h,s("h3",_,[m,v,s("a",y,[g,a(o)]),w,s("a",f,[b,a(o)])]),s("p",null,[x,a(p,{to:"/en/guide/server/databases.html#sqlite"},{default:k(()=>[E]),_:1}),S]),A,a(c,{data:[{title:"npm",content:`<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> @waline/vercel
<span class="token function">node</span> node_modules/@waline/vercel/vanilla.js
</code></pre></div>`},{title:"yarn",content:`<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token function">yarn</span> <span class="token function">add</span> @waline/vercel
<span class="token function">node</span> node_modules/@waline/vercel/vanilla.js
</code></pre></div>`}],"tab-id":"shell"},null,8,["data"]),L],64)}var N=l(u,[["render",C],["__file","vps-deploy.html.vue"]]);export{N as default};
