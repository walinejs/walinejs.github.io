import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as c,c as l,b as n,e as a,f as t,a as p,d as o,r as u}from"./app.ce144736.js";const i={},k=n("p",null,"There are many plugins that can achieve the lightbox effect, here are some examples of these plugins:",-1),r={href:"https://www.lightgalleryjs.com/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://lokeshdhakar.com/projects/lightbox2/",target:"_blank",rel:"noopener noreferrer"},d={href:"https://fancyapps.com/docs/ui/fancybox/",target:"_blank",rel:"noopener noreferrer"},h=o(`<h2 id="lightgallery" tabindex="-1"><a class="header-anchor" href="#lightgallery" aria-hidden="true">#</a> LightGallery</h2><p>Write the following content before your HTML <code>&lt;head&gt;</code>, where <code>#waline-comment</code> is your Waline comment box, which needs to be replaced according to the actual scene.</p><div class="language-html" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span>
...
</code></pre></div>`,3),m=o(`<h2 id="lightbox2" tabindex="-1"><a class="header-anchor" href="#lightbox2" aria-hidden="true">#</a> Lightbox2</h2><p>Write the following content before your HTML <code>&lt;head&gt;</code>, where <code>#waline-comment</code> is your Waline comment box, which needs to be replaced according to the actual scene.</p><div class="language-html" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span>
  <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>stylesheet<span class="token punctuation">&quot;</span></span>
...
</code></pre></div>`,6);function f(y,b){const s=u("ExternalLinkIcon");return c(),l("div",null,[k,n("ul",null,[n("li",null,[n("a",r,[a("lightGallery"),t(s)])])]),p(" - [Slimbox2](https://www.digitalia.be/software/slimbox2/) "),n("ul",null,[n("li",null,[n("a",g,[a("lightbox2"),t(s)])]),n("li",null,[n("a",d,[a("Fancybox"),t(s)])])]),p(" more "),h,p(`
##Slimbox2
...
<\/script>
\`\`\` `),m])}const v=e(i,[["render",f],["__file","image-preview.html.vue"]]);export{v as default};
