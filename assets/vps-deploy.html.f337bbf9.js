...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function S(A,L){const o=t("ExternalLinkIcon"),c=t("RouterLink"),l=t("CodeTabs");return u(),_("div",null,[h,s("h3",v,[y,n(" 使用 "),s("a",g,[n("docker stack deploy"),a(o)]),n(" 或者 "),s("a",b,[n("docker-compose"),a(o)])]),s("p",null,[n("这里使用了 SQLite 数据库作为例子。关于 SQLite 和支持的数据库服务，请参考"),a(c,{to:"/guide/server/databases.html#sqlite"},{default:e(()=>[n("多数据库服务支持")]),_:1}),n("。")]),w,a(l,{id:"29",data:[{title:"yarn"},{title:"npm"}],"tab-id":"shell"},{tab0:e(({title:r,value:i,isActive:k})=>[x]),tab1:e(({title:r,value:i,isActive:k})=>[E]),_:1}),f])}const D=d(m,[["render",S],["__file","vps-deploy.html.vue"]]);export{D as default};
