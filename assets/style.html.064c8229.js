import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as p,a as t,b as n,e as o,d as e}from"./app.2d2ef0cf.js";const c={},l=n("p",null,[n("code",null,"@waline/client"),o(" 提供了一些 CSS 变量。你可以很轻松的通过这些变量配置 waline 的样式。")],-1),u=e(`<h2 id="提供的变量与默认值" tabindex="-1"><a class="header-anchor" href="#提供的变量与默认值" aria-hidden="true">#</a> 提供的变量与默认值</h2><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,2);function i(r,k){return s(),p("div",null,[l,t(" more "),u])}const w=a(c,[["render",i],["__file","style.html.vue"]]);export{w as default};
