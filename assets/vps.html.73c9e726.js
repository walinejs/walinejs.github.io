...
</code></pre></div></div>`,4),g={id:"via-docker-stack-deploy-or-docker-compose",tabindex:"-1"},b=n("a",{class:"header-anchor",href:"#via-docker-stack-deploy-or-docker-compose","aria-hidden":"true"},"#",-1),f={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},w={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},x=o(`<p>Example <code>docker-compose.yml</code> for <code>waline</code>:</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function L(C,T){const p=t("ExternalLinkIcon"),c=t("RouterLink"),l=t("CodeTabs");return u(),m("div",null,[_,h(" more "),y,n("h3",g,[b,s(" via "),n("a",f,[s("docker stack deploy"),a(p)]),s(" or "),n("a",w,[s("docker-compose"),a(p)])]),n("p",null,[s("The SQLite is used here as an example. For SQLite and supported database services, please refer to "),a(c,{to:"/en/guide/database.html#sqlite"},{default:e(()=>[s("Multi-database service support")]),_:1}),s(".")]),x,a(l,{id:"30",data:[{title:"npm"},{title:"yarn"}],"tab-id":"shell"},{tab0:e(({title:r,value:i,isActive:k})=>[E]),tab1:e(({title:r,value:i,isActive:k})=>[S]),_:1}),A])}const N=d(v,[["render",L],["__file","vps.html.vue"]]);export{N as default};
