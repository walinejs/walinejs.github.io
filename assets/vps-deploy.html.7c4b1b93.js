...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function I(N,H){const p=e("ExternalLinkIcon"),c=e("RouterLink"),l=e("CodeTabs");return u(),h("div",null,[m,n("h3",v,[y,g,n("a",w,[f,a(p)]),b,n("a",x,[E,a(p)])]),n("p",null,[S,a(c,{to:"/en/guide/server/databases.html#sqlite"},{default:t(()=>[A]),_:1}),L]),C,a(l,{data:[{title:"npm"},{title:"yarn"}],"tab-id":"shell"},{tab0:t(({title:r,value:i,isActive:k})=>[T]),tab1:t(({title:r,value:i,isActive:k})=>[R]),_:1}),D])}var M=d(_,[["render",I],["__file","vps-deploy.html.vue"]]);export{M as default};
