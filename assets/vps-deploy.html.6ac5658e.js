...
</code></pre></div><h2 id="run-directly-recommended" tabindex="-1"><a class="header-anchor" href="#run-directly-recommended" aria-hidden="true">#</a> Run directly (Recommended)</h2><p>It&#39;s easy to run without using docker deployment, after setting environment variables, just run the <code>vanilla.js</code> file in the module after installing.</p>`,4),f=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),s(),n("span",{class:"token function"},"install"),s(` @waline/vercel
`),n("span",{class:"token function"},"node"),s(` node_modules/@waline/vercel/vanilla.js
`)])])],-1),x=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"yarn"),s(),n("span",{class:"token function"},"add"),s(` @waline/vercel
`),n("span",{class:"token function"},"node"),s(` node_modules/@waline/vercel/vanilla.js
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function S(A,L){const p=t("ExternalLinkIcon"),c=t("RouterLink"),l=t("CodeTabs");return u(),m("div",null,[v,n("h3",_,[y,s(" via "),n("a",g,[s("docker stack deploy"),a(p)]),s(" or "),n("a",b,[s("docker-compose"),a(p)])]),n("p",null,[s("The SQLite is used here as an example. For SQLite and supported database services, please refer to "),a(c,{to:"/en/guide/server/databases.html#sqlite"},{default:e(()=>[s("Multi-database service support")]),_:1}),s(".")]),w,a(l,{id:"29",data:[{title:"npm"},{title:"yarn"}],"tab-id":"shell"},{tab0:e(({title:r,value:i,isActive:k})=>[f]),tab1:e(({title:r,value:i,isActive:k})=>[x]),_:1}),E])}const R=d(h,[["render",S],["__file","vps-deploy.html.vue"]]);export{R as default};
