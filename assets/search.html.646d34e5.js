import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as p,a as o,b as n,e as s,d as e}from"./app.c71527b4.js";const c={},l=n("p",null,[s("本教程指引你如何通过 "),n("code",null,"@waline/client"),s(" 提供的 "),n("code",null,"search"),s(" 选项自定设置表情包搜索服务。")],-1),u=e(`<h2 id="搜索结果转换" tabindex="-1"><a class="header-anchor" href="#搜索结果转换" aria-hidden="true">#</a> 搜索结果转换</h2><p>你在使用不同的第三方图片搜索服务时，可能会得到不同的结果。在获取到搜索结果后，你需要将其转换为 <code>@waline/client</code> 所需要的格式。</p><p>对于下文的任何操作，<code>@waline/client</code> 都要求你返回如下格式的图片信息的数组:</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">WalineSearchImageData</span> <span class="token keyword">extends</span> <span class="token class-name">Record<span class="token operator">&lt;</span><span class="token builtin">string</span><span class="token punctuation">,</span> <span class="token builtin">unknown</span><span class="token operator">&gt;</span></span> <span class="token punctuation">{</span>
...
</code></pre></div><p>你需要保证数组的每个对象至少含有 <code>src</code> 属性来注明图片的地址。</p><p>并且，你应当尽可能提供一个替代文字 <code>title</code> 以便于帮助无障碍访问以及应对图片服务失效的情况。</p><p>为了让列表加载更快，只要图片服务可以返回多个尺寸的图片地址，你就应该选用一个小尺寸的图片作为 <code>preview</code> 以提升列表图片加载速度。</p><div class="custom-container note"><p class="custom-container-title">注</p><p><code>@waline/client</code> 并不在意图像结果中是否有额外属性，所以你无需刻意移除返回结果中的其他键值。</p></div><h2 id="搜索配置" tabindex="-1"><a class="header-anchor" href="#搜索配置" aria-hidden="true">#</a> 搜索配置</h2><p><code>@waline/client</code> 提供三个子选项以控制搜索行为:</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">WalineSearchOptions</span> <span class="token punctuation">{</span>
  <span class="token doc-comment comment">/**
   * 搜索操作
   */</span>
...
</code></pre></div><p>通常情况下，你的搜索服务商会支持分页服务，所以我们提供一个 <code>more</code> 函数来在用户滑动到底部时触发并加载更多图片来让你返回更多结果。为了更好的体验，我们推荐将分页数设置为 20 - 40，即每次加载 20 - 40 张图片。</p><div class="custom-container tip"><p class="custom-container-title">一个帮助理解的例子</p><p>当用户点击表情包搜索按钮时，我们会触发 <code>default()</code>，如果此函数缺失，我们会触发 <code>search(&#39;&#39;)</code>，同时我们将等待 Promise 执行并使用返回结果渲染，这样用户可以在。</p><p>当用户搜索 <code>微笑</code>，我们会执行 <code>search(&#39;微笑&#39;)</code>。假定你每次返回 20 个结果，用户持续向下滚动时，我们会依次触发 <code>more(&#39;微笑&#39;, 20)</code>、<code>more(&#39;微笑&#39;, 40)</code>、<code>more(&#39;微笑&#39;, 60)</code> ...</p></div><h2 id="案例" tabindex="-1"><a class="header-anchor" href="#案例" aria-hidden="true">#</a> 案例</h2><details class="custom-container details"><summary>默认实现</summary><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code>File not found</code></pre></div></details><details class="custom-container details"><summary>Tenor V1</summary><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">FetchGifRequest</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">)</span><span class="token operator">:</span> WalineSearchOptions <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div></details>`,19);function i(k,r){return t(),p("div",null,[l,o(" more "),u])}const g=a(c,[["render",i],["__file","search.html.vue"]]);export{g as default};
