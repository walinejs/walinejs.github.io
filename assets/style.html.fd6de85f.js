import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as p,f as o,a as n,b as a,e}from"./app.32b24f06.js";const c={},l=n("p",null,[n("code",null,"@waline/client"),a(" 提供了一些 CSS 变量。你可以很轻松的通过这些变量配置 waline 的样式。")],-1),u=n("p",null,[a("同时 "),n("code",null,"@waline/client"),a(" 还拥有内置的暗黑模式支持。")],-1),i=e(`<h2 id="提供的变量" tabindex="-1"><a class="header-anchor" href="#提供的变量" aria-hidden="true">#</a> 提供的变量</h2><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>如果上述颜色与你的站点夜间模式颜色不同，你可以考虑手动添加 CSS 并自行覆盖他们。</p><h2 id="meta-图标" tabindex="-1"><a class="header-anchor" href="#meta-图标" aria-hidden="true">#</a> Meta 图标</h2><p>如果你希望给用户评论的 meta 数据加上图标的话，你可以导入 <code>waline-meta.css</code> 来使用它。</p><p>对于 CDN 用户，你可以通过以下链接导入:</p><div class="language-html" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!-- Meta 图标 (可选) --&gt;</span>
...
</code></pre></div><p>对于 NPM 用户，你可以通过以下方式导入:</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token string">&#39;@waline/client/dist/waline-meta.css&#39;</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="阴影样式" tabindex="-1"><a class="header-anchor" href="#阴影样式" aria-hidden="true">#</a> 阴影样式</h2><p>如果你在使用一个大量运用阴影 (<code>box-shadow</code>) 的主题，你可以通过修改 <code>--waline-border</code> 和 <code>--waline-box-shadow</code> 来更改 Waline 的显示效果，如:</p><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
<span class="token atrule"><span class="token rule">@media</span> <span class="token punctuation">(</span><span class="token property">prefers-color-scheme</span><span class="token punctuation">:</span> dark<span class="token punctuation">)</span></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="更多" tabindex="-1"><a class="header-anchor" href="#更多" aria-hidden="true">#</a> 更多</h2><p>如果上面的 CSS 变量无法满足你对 Waline 样式的定制要求，你可以停止导入 Waline 官方提供的样式，并自己制作 CSS。</p>`,24);function r(k,d){return t(),p("div",null,[l,u,o(" more "),i])}const w=s(c,[["render",r],["__file","style.html.vue"]]);export{w as default};
