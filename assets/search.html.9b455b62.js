import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as p,a as o,b as n,e as s,d as e}from"./app.8885c8b4.js";const c={},l=n("p",null,[s("This tutorial guides you on how to customize the emoji search service via the "),n("code",null,"search"),s(" option provided by "),n("code",null,"@waline/client"),s(".")],-1),i=e(`<h2 id="search-result-conversion" tabindex="-1"><a class="header-anchor" href="#search-result-conversion" aria-hidden="true">#</a> search result conversion</h2><p>You may get different results when using different third-party image search services. After getting the search result, you need to convert it to the format required by <code>@waline/client</code>.</p><p>For any of the following operations, <code>@waline/client</code> requires you to return an array of image information in the following format:</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">WalineSearchImageData</span> <span class="token keyword">extends</span> <span class="token class-name">Record<span class="token operator">&lt;</span><span class="token builtin">string</span><span class="token punctuation">,</span> <span class="token builtin">unknown</span><span class="token operator">&gt;</span></span> <span class="token punctuation">{</span>
...
</code></pre></div><p>You need to ensure that each object of the array contains at least the <code>src</code> attribute to indicate the address of the image.</p><p>Also, where possible, you should provide an alt text <code>title</code> to help with accessibility and in case of image service failures.</p><p>In order to make the list load faster, as long as the image service can return multiple sizes of image URLs, you should choose a small size image as <code>preview</code> to improve the loading speed of the list image.</p><div class="custom-container note"><p class="custom-container-title">Note</p><p><code>@waline/client</code> doesn&#39;t care if there are extra properties in the image result, so you don&#39;t need to deliberately remove other keys from the returned result.</p></div><h2 id="search-option" tabindex="-1"><a class="header-anchor" href="#search-option" aria-hidden="true">#</a> Search Option</h2><p><code>@waline/client</code> provides three sub-options to control search behavior:</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">WalineSearchOptions</span> <span class="token punctuation">{</span>
  <span class="token doc-comment comment">/**
   * Search action
   */</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>Since you need to implement at least the search logic, <code>search</code> is required. <code>@waline/client</code> will pass in the user search term and call this option function, and wait for this function to return a Promise to complete the search result.</p><p>We want users to see some hot images or emoji results when they open it, so we provide the <code>default</code> function to implement this behavior. If your service provider provides an interface for popular pictures or emoticons, you should use this interface to return content. Also, since the default behavior of this function is to search for empty strings, if your search provider returns empty results in this situation, we recommend that you add a brief implementation of random preset words to avoid showing an empty list.</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">search</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">word</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>Usually, your search service will support pagination, so we provide a <code>more</code> function to trigger when the user swipes to the bottom and load more images to let you return more results. For a better experience, we recommend setting the number of pagination to 20 - 40, that is, 20 - 40 images are loaded each time.</p><div class="custom-container tip"><p class="custom-container-title">An example to help understand</p><p>When the user clicks the search button, we will trigger <code>default()</code>, if this function is missing, we will trigger <code>search(&#39;&#39;)</code>, and we will wait for the Promise to execute and render with the returned result.</p><p>When the user searches for <code>smile</code>, we execute <code>search(&#39;smile&#39;)</code>. Suppose you return 20 results each time, when the user continues to scroll down, we will trigger <code>more(&#39;smile&#39;, 20)</code>, <code>more(&#39;smile&#39;, 40)</code>, <code>more(&#39;smile&#39;, 60 )</code> ...</p></div><h2 id="examples" tabindex="-1"><a class="header-anchor" href="#examples" aria-hidden="true">#</a> Examples</h2><details class="custom-container details"><summary>Default implementation</summary><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code>File not found</code></pre></div></details><details class="custom-container details"><summary>Tenor V1</summary><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">FetchGifRequest</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">)</span><span class="token operator">:</span> WalineSearchOptions <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div></details>`,19);function u(r,k){return t(),p("div",null,[l,o(" more "),i])}const h=a(c,[["render",u],["__file","search.html.vue"]]);export{h as default};
