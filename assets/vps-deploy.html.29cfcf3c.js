...
</code></pre></div></div>`,5),_={id:"\u4F7F\u7528-docker-stack-deploy-\u6216\u8005-docker-compose",tabindex:"-1"},h=s("a",{class:"header-anchor",href:"#\u4F7F\u7528-docker-stack-deploy-\u6216\u8005-docker-compose","aria-hidden":"true"},"#",-1),m=n(" \u4F7F\u7528 "),v={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},y=n("docker stack deploy"),g=n(" \u6216\u8005 "),w={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},x=n("docker-compose"),b=n("\u8FD9\u91CC\u4F7F\u7528\u4E86 SQLite \u6570\u636E\u5E93\u4F5C\u4E3A\u4F8B\u5B50\u3002\u5173\u4E8E SQLite \u548C\u652F\u6301\u7684\u6570\u636E\u5E93\u670D\u52A1\uFF0C\u8BF7\u53C2\u8003"),E=n("\u591A\u6570\u636E\u5E93\u670D\u52A1\u652F\u6301"),f=n("\u3002"),S=p(`<p><code>docker-compose.yml</code> \u793A\u4F8B:</p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
</code></pre></div><h2 id="\u76F4\u63A5\u8FD0\u884C-\u63A8\u8350" tabindex="-1"><a class="header-anchor" href="#\u76F4\u63A5\u8FD0\u884C-\u63A8\u8350" aria-hidden="true">#</a> \u76F4\u63A5\u8FD0\u884C (\u63A8\u8350)</h2><p>\u4E0D\u4F7F\u7528\u5BB9\u5668\u90E8\u7F72\u7684\u8BDD\u8FD0\u884C\u4E5F\u5F88\u7B80\u5355\u3002\u5728\u914D\u7F6E\u5FC5\u8981\u7684\u73AF\u5883\u53D8\u91CF\u540E\uFF0C\u5B89\u88C5\u597D\u6A21\u5757\u540E\u76F4\u63A5\u8FD0\u884C\u6A21\u5757\u5185\u7684 <code>vanilla.js</code> \u6587\u4EF6\u5373\u53EF\u3002</p><p>::: code-tabs</p><p>@tab npm</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> @waline/vercel
<span class="token function">node</span> node_modules/@waline/vercel/vanilla.js
</code></pre></div><p>@tab yarn</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">yarn</span> <span class="token function">add</span> @waline/vercel
<span class="token function">node</span> node_modules/@waline/vercel/vanilla.js
</code></pre></div><p>:::</p><h2 id="nginx-\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#nginx-\u914D\u7F6E" aria-hidden="true">#</a> Nginx \u914D\u7F6E</h2><p>\u5982\u679C\u4F60\u4E0D\u60F3\u5E26\u7AEF\u53E3\u8BBF\u95EE\u7684\u8BDD\uFF0C\u53EF\u4EE5\u589E\u52A0 Nginx 80 \u548C 443 \u7AEF\u53E3\u7684\u53CD\u4EE3\u3002\u53EF\u53C2\u8003\u5982\u4E0B\u914D\u7F6E:</p><div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span>
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,13);function A(L,C){const e=t("ExternalLinkIcon"),o=t("RouterLink");return l(),r(k,null,[u,s("h3",_,[h,m,s("a",v,[y,a(e)]),g,s("a",w,[x,a(e)])]),s("p",null,[b,a(o,{to:"/guide/server/databases.html#sqlite"},{default:i(()=>[E]),_:1}),f]),S],64)}var T=c(d,[["render",A],["__file","vps-deploy.html.vue"]]);export{T as default};
