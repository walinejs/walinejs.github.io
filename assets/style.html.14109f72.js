import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as e,f as o,a as n,d as a,e as p}from"./app.de9db869.js";const c={},l=n("p",null,[n("code",null,"@waline/client"),a(" provides some CSS variables. You can easily configure the style of waline through these variables:")],-1),i=n("p",null,[a("Meanwhile, "),n("code",null,"@waline/client"),a(" also has built-in dark mode support.")],-1),r=p(`<h2 id="variables" tabindex="-1"><a class="header-anchor" href="#variables" aria-hidden="true">#</a> Variables</h2><div class="language-css ext-css"><pre class="language-css"><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>If the above colors are different from the darkmode palette of your site, you can override them instead of setting the <code>dark</code> option.</p><h2 id="meta-icons" tabindex="-1"><a class="header-anchor" href="#meta-icons" aria-hidden="true">#</a> Meta Icons</h2><p>If you want to add icons to user comment meta data, you can import <code>waline-meta.css</code> to use it.</p><p>For CDN users, you can import via the following link:</p><div class="language-html ext-html"><pre class="language-html"><code><span class="token comment">&lt;!-- Meta icon (optional) --&gt;</span>
...
</code></pre></div><p>For NPM users, you can import via:</p><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token string">&#39;@waline/client/dist/waline-meta.css&#39;</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="box-shadow" tabindex="-1"><a class="header-anchor" href="#box-shadow" aria-hidden="true">#</a> Box Shadow</h2><p>If you are using a theme that uses shadows (<code>box-shadow</code>) instead of borders, you can modify the display effect of Waline by modifying <code>--waline-border</code> and <code>--waline-box-shadow</code>, e.g.:</p><div class="language-css ext-css"><pre class="language-css"><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
<span class="token atrule"><span class="token rule">@media</span> <span class="token punctuation">(</span><span class="token property">prefers-color-scheme</span><span class="token punctuation">:</span> dark<span class="token punctuation">)</span></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="more" tabindex="-1"><a class="header-anchor" href="#more" aria-hidden="true">#</a> More</h2><p>If the above CSS variables cannot meet your custom requirements for Waline styles, you can write your own css file.</p>`,24);function u(d,k){return t(),e("div",null,[l,i,o(" more "),r])}const y=s(c,[["render",u],["__file","style.html.vue"]]);export{y as default};
