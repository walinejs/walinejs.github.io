...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,13);function A(L,R){const e=t("ExternalLinkIcon"),p=t("RouterLink");return l(),r(k,null,[u,s("h3",h,[m,_,s("a",v,[y,a(e)]),g,s("a",w,[f,a(e)])]),s("p",null,[b,a(p,{to:"/en/guide/databases.html#sqlite"},{default:i(()=>[x]),_:1}),E]),S],64)}var I=c(d,[["render",A],["__file","vps-deploy.html.vue"]]);export{I as default};
