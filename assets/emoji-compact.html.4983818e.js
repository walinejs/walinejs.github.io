...
<span class="token punctuation">}</span>
</code></pre></div>`,7);function g(h,_){const s=r("RouterLink");return p(),e("div",null,[k,o(" more "),m,a("p",null,[n("Waline 提供了一个 "),c(s,{to:"/cookbook/legacy.html"},{default:l(()=>[n("legacy 版本")]),_:1}),n("，对 Valine 的 emoji 选项进行了兼容。")]),d])}const v=t(u,[["render",g],["__file","emoji-compact.html.vue"]]);export{v as default};
