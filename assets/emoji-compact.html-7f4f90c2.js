import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as e,c as o,a as c,b as a,e as n,f as l,w as i,d as r}from"./app-63920265.js";const u={},k=a("p",null,"本指南将指导如何兼容 Valine，以及上古版本的 Waline。",-1),m=a("h2",{id:"兼容-valine",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#兼容-valine","aria-hidden":"true"},"#"),n(" 兼容 Valine")],-1),d=r(`<p>在 legacy 版本中，你可以使用 <code>emojiCDN</code> 设置 emoji 图片地址前缀，并使用 <code>emojiMaps</code> 设置表情 title 与图片的映射。</p><div class="language-html" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!-- 使用与 Valine 和 Waline V1 客户端兼容的 Legacy 版本 --&gt;</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,7);function g(h,_){const s=p("RouterLink");return e(),o("div",null,[k,c(" more "),m,a("p",null,[n("Waline 提供了一个 "),l(s,{to:"/cookbook/legacy.html"},{default:i(()=>[n("legacy 版本")]),_:1}),n("，对 Valine 的 emoji 选项进行了兼容。")]),d])}const v=t(u,[["render",g],["__file","emoji-compact.html.vue"]]);export{v as default};
