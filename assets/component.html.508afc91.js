...
`)])],-1),B=e("div",{class:"language-html ext-html"},[e("pre",{class:"language-html"},[e("code",null,`<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
`)])],-1),A=n('<h2 id="copyright" tabindex="-1"><a class="header-anchor" href="#copyright" aria-hidden="true">#</a> copyright</h2><ul><li>Type: <code>boolean</code></li><li>Default: <code>true</code></li></ul><p>Whether show copyright and version in footer.</p><div class="custom-container tip"><p class="custom-container-title">Tips</p><p>We hope you can keep it on to support Waline.</p></div>',4);function G(H,V){const i=l("RouterLink"),o=l("ExternalLinkIcon"),r=l("CodeGroupItem"),c=l("CodeGroup");return p(),h(m,null,[g,e("p",null,[x,s(i,{to:"/en/guide/client/i18n.html"},{default:a(()=>[v]),_:1}),w]),y,f,e("p",null,[_,s(i,{to:"/en/guide/client/emoji.html"},{default:a(()=>[k]),_:1})]),b,e("p",null,[T,s(i,{to:"/en/guide/client/style.html"},{default:a(()=>[q]),_:1}),M]),j,D,e("p",null,[W,L,C,R,E,S,U,e("a",X,[I,s(o)]),P,e("a",F,[N,s(o)]),z]),e("details",Y,[J,s(c,null,{default:a(()=>[s(r,{title:"KaTex"},{default:a(()=>[O]),_:1}),s(r,{title:"MathJax"},{default:a(()=>[B]),_:1})]),_:1})]),A],64)}var Q=d(u,[["render",G],["__file","component.html.vue"]]);export{Q as default};
