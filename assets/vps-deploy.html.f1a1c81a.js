...
</code></pre></div></div>`,5),v={id:"\u4F7F\u7528-docker-stack-deploy-\u6216\u8005-docker-compose",tabindex:"-1"},y=s("a",{class:"header-anchor",href:"#\u4F7F\u7528-docker-stack-deploy-\u6216\u8005-docker-compose","aria-hidden":"true"},"#",-1),g=n(" \u4F7F\u7528 "),w={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},x=n("docker stack deploy"),b=n(" \u6216\u8005 "),E={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},f=n("docker-compose"),S=n("\u8FD9\u91CC\u4F7F\u7528\u4E86 SQLite \u6570\u636E\u5E93\u4F5C\u4E3A\u4F8B\u5B50\u3002\u5173\u4E8E SQLite \u548C\u652F\u6301\u7684\u6570\u636E\u5E93\u670D\u52A1\uFF0C\u8BF7\u53C2\u8003"),A=n("\u591A\u6570\u636E\u5E93\u670D\u52A1\u652F\u6301"),L=n("\u3002"),C=p(`<p><code>docker-compose.yml</code> \u793A\u4F8B:</p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function R(H,I){const o=t("ExternalLinkIcon"),c=t("RouterLink"),l=t("CodeTabs");return u(),_("div",null,[m,s("h3",v,[y,g,s("a",w,[x,a(o)]),b,s("a",E,[f,a(o)])]),s("p",null,[S,a(c,{to:"/guide/server/databases.html#sqlite"},{default:e(()=>[A]),_:1}),L]),C,a(l,{data:[{title:"yarn"},{title:"npm"}],"tab-id":"shell"},{tab0:e(({title:i,value:r,isActive:k})=>[T]),tab1:e(({title:i,value:r,isActive:k})=>[D]),_:1}),N])}var M=d(h,[["render",R],["__file","vps-deploy.html.vue"]]);export{M as default};
