...
</code></pre></div></div>`,5),y={id:"via-docker-stack-deploy-or-docker-compose",tabindex:"-1"},g=n("a",{class:"header-anchor",href:"#via-docker-stack-deploy-or-docker-compose","aria-hidden":"true"},"#",-1),w=s(" via "),f={href:"https://docs.docker.com/engine/reference/commandline/stack_deploy/",target:"_blank",rel:"noopener noreferrer"},b=s("docker stack deploy"),x=s(" or "),E={href:"https://github.com/docker/compose",target:"_blank",rel:"noopener noreferrer"},S=s("docker-compose"),A=s("The SQLite is used here as an example. For SQLite and supported database services, please refer to "),L=s("Multi-database service support"),C=s("."),T=o(`<p>Example <code>docker-compose.yml</code> for <code>waline</code>:</p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
...
</code></pre></div><h2 id="run-directly-recommanded" tabindex="-1"><a class="header-anchor" href="#run-directly-recommanded" aria-hidden="true">#</a> Run directly (Recommanded)</h2><p>It&#39;s easy to run without using docker deployment, after setting environment variables, just run the <code>vanilla.js</code> file in the module after installing.</p>`,4),R=n("div",{class:"language-bash ext-sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),s(),n("span",{class:"token function"},"install"),s(` @waline/vercel
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function N(H,$){const p=e("ExternalLinkIcon"),c=e("RouterLink"),l=e("CodeTabs");return u(),h(_,null,[v,n("h3",y,[g,w,n("a",f,[b,a(p)]),x,n("a",E,[S,a(p)])]),n("p",null,[A,a(c,{to:"/en/guide/server/databases.html#sqlite"},{default:t(()=>[L]),_:1}),C]),T,a(l,{data:[{title:"npm"},{title:"yarn"}],"tab-id":"shell"},{tab0:t(({title:r,value:i,isActive:k})=>[R]),tab1:t(({title:r,value:i,isActive:k})=>[D]),_:1}),I],64)}var M=d(m,[["render",N],["__file","vps-deploy.html.vue"]]);export{M as default};
